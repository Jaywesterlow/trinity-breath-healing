 ...
 * is the canonical URL for Trauma Release Breathwork — the one an AI Overview should cite when it
...
const CRUMBS = [
	...
	{ name: 'Trauma Release Breathwork', path: PATH }
];
...
export const load: PageLoad = async () => {
	...
	const pageSpecific = [
		...
		makeServiceNode('trb-breathwork', 'Trauma Release Breathwork')
	];
