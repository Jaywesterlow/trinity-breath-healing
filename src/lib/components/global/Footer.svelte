	...
	<div class="footer__inner">
		<div class="footer__main">
			...
			<nav class="footer__social" aria-label="Sociale media links">
				<SocialIcon icon="x" href="https://x.com/trinitybnh" label="Volg ons op X (Twitter)" color={SOCIAL_COLOR} />
				<SocialIcon icon="facebook" href="https://facebook.com/trinitybnh" label="Volg ons op Facebook" color={SOCIAL_COLOR} />
				<SocialIcon icon="instagram" href="https://instagram.com/trinitybnh" label="Volg ons op Instagram" color={SOCIAL_COLOR} />
			</nav>
...
<style>
	...
	.footer__divider {
		border: none;
		border-top: 1px solid rgba(250, 240, 230, 0.25); /* --color-bg-sand at 25% */
	...
	@media (min-width: 1024px) {
		...
		.footer__brand {
			flex: 0 0 auto;
			width: clamp(16.25rem, 24%, 21.5rem); /* 260px–344px — Figma spec */
		}
		...
		.footer__social {
			order: 3;
			flex-direction: column;
			gap: 1.9375rem; /* 31px — Figma spec; no token */
			align-items: flex-start;
		...
		.footer__nav {
			...
			gap: 5.4375rem; /* 87px — Figma spec; no token */
			align-self: flex-start;
		}
