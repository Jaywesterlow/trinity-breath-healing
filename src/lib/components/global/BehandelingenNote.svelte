...
<style>
	...
	.note__text {
		...
		/* Between the section headings (--fs-h2) and body copy: large enough to
		   carry the whole width on its own, quiet enough not to read as a title. */
		font-size: clamp(1.375rem, 1.1rem + 1.2vw, 1.875rem); /* 22 → 30px */
