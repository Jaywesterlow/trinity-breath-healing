<script lang="ts">
	 ...
	 * the section's end. The sentence is an h2 now, set large and centred, and on
	 * desktop it breaks by hand after "nodig" so the two lines are the two halves
	 * of the thought rather than wherever the measure happened to fall.
	 *
...
<!-- One reveal for the block: heading and disclaimer together are 285px at
     1440x900 and 232px at 390x844, inside the third of the viewport the
...
<style>
	...
	.note__heading {
		...
		/* 42px from the desktop breakpoint up, 28px on a phone: the same slope as the
		   site's --fs-h2 tokens (390px -> 1024px), one step larger at the top. */
		font-size: clamp(1.75rem, 1.213rem + 2.208vw, 2.625rem);
